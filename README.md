...
2. Ejecuta el siguiente comando para iniciar la aplicación: **mvn spring-boot:run**
3. Cuando el servidor arranque correctamente, abre tu navegador y accede a: **localhost:8080**
